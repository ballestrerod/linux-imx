...
static const struct snd_soc_codec_driver soc_codec_dev_enobu_fpga_auxaudio = {
	.component_driver = {
...
static int enobu_fpga_auxaudio_platform_probe(struct platform_device *pdev)
{
	return snd_soc_register_codec(&pdev->dev,
			&soc_codec_dev_enobu_fpga_auxaudio, &enobu_fpga_auxaudio_dai, 1);
}

static int enobu_fpga_auxaudio_platform_remove(struct platform_device *pdev)
{
...
static struct platform_driver enobu_fpga_auxaudio_codec_driver = {
	...
	.remove = enobu_fpga_auxaudio_platform_remove,
};
